    ...
    def form_valid(self, form):
        ...
        if user is not None:
            ...
            messages.add_message(
                self.request, messages.ERROR, "Invalid credintial"
            )
            return redirect(self.request.path_info)

    def form_invalid(self, form):
        messages.add_message(
            self.request, messages.ERROR, "Invalid captcha or input data"
        )
        return redirect(self.request.path_info)
...
def signup_user(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            messages.add_message(
                request, messages.ERROR, "Invalid input data"
            )
        ...
        if form.is_valid():
            ...
            if (pass1 == pass2) and not (user.check_password(pass1)):
                ...
                messages.add_message(
                    request,
                    messages.ERROR,
                    """password and pass2 must be similar or 
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.add_message(
                    request, messages.ERROR, "user not found"
                )
                return redirect(request.path_info)
            else:
        ...
        if form.is_valid():
            ...
            if (pass1 == pass2) and not (user.check_password(pass1)):
                ...
                messages.add_message(
                    request,
                    messages.ERROR,
                    "password and pass2 must be similar or different between old and new",
                )
                return redirect(request.path_info)
        else:
            messages.add_message(
...
def edit_profile(request, id):
    ...
    if request.method == "POST":
        ...
        return render(
            request, "registration/edit-profile.html", context=context
        )
