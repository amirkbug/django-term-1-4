...
class Command(BaseCommand):
    ...
    help = "this is the first help we made"
    ...
    def handle(self, *args, **options):
        ...
        # list_ablity = Ability.objects.all()
        # for _ in range(10):
        #     user = random.choice(list_users)
        #     ability = random.choice(list_ablity)
        ...
        for _ in range(10):
            ...
            service = Services.objects.create(title = self.fake.name() , creator=agent , status=True)
